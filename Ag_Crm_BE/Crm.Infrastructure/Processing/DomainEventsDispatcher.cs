...
namespace Crm.Infrastructure.Processing
{
    public class DomainEventsDispatcher : IDomainEventsDispatcher
    {
        ...
        public DomainEventsDispatcher(IMediator mediator, ILifetimeScope scope, CompaniesContext ordersContext)
        {
            _mediator = mediator;
            _scope = scope;
        ...
        {
            var domainEntities = _companiesContext.ChangeTracker
                .Entries<Entity>()
            ...
            //        type,
            //        data);
            //    this._companiesContext.OutboxMessages.Add(outboxMessage);
            //}
        }
    }
}